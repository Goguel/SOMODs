...
public class NovoCPFCliController {
	...
	@FXML
	private TextField txtNovoCPFCli;
	@FXML
	private TextField txtBuscaCli;
	@FXML
	private Button btnAplicar;
	
	public NovoCPFCliController() {
	...
	public void onAplicarClick() throws IOException {
		if(txtBuscaCli.getText() != "") {
			if(txtNovoCPFCli.getText() != "") {
				if(conC.buscaCliente(txtBuscaCli.getText())){
				conC.alteraCliente(txtBuscaCli.getText(), txtNovoCPFCli.getText(), 2);
				alert3.show();
